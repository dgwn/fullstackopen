...
describe("total likes", () => {
  ...
  test("when list has many blogs, add up the total likes", () => {
    expect(listHelper.totalLikes(listWithManyBlogs)).toBe(36);
  });
});

describe("favorite blog", () => {
  test("when list has one blog, it has the most likes", () => {
...
describe("most Likes", () => {
  test("when list has only one blog, list its author and number of likes", () => {
